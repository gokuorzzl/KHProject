...
/**
 * Servlet implementation class FreeOneSelectServlet
 */
@WebServlet(name = "FreeOneSelect", urlPatterns = { "/freeOneSelect.do" })
public class FreeOneSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeOneSelectServlet() {
        super();
