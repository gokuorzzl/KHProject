...
public class TrainerInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadPath = getServletContext().getRealPath("/")+"uploadFile"+"\\"+memberId;
...
//		System.out.println("멤버의아이디디디디"+userId);
	    ...
	    System.out.println("trainerEvent읙밧값값"+trainerEvent);
		    ...
		    Date careerStart1 = null;
		    Date careerEnd1 = null;
		    String careerName1=null;
		    
		    Date careerStart2 = null;
		    Date careerEnd2 = null;
		    String careerName2=null;
		    
		    Date careerStart3 = null;
		    Date careerEnd3 = null;
		    String careerName3=null;
		    
		    Date careerStart4 = null;
		    Date careerEnd4 = null;
		    String careerName4=null;
		    
		    Date careerStart5 = null;
		    Date careerEnd5 = null;
		    String careerName5=null;
		    
		    String licenseName1 = null;
		    String licenseName2 = null;
		    String licenseName3 = null;
		    String licenseName4 = null;
		    String licenseName5 = null;
	    ...
	    careerStart1 = Date.valueOf(multi.getParameter("careerStart1"));
	    System.out.println("careerStart1adasdas"+careerStart1);
		careerEnd1 = Date.valueOf(multi.getParameter("careerEnd1"));
		careerName1 = multi.getParameter("careerName1");
	    System.out.println("careerName1"+careerName1);
	    
	    
		careerStart2 = Date.valueOf(multi.getParameter("careerStart2"));
		System.out.println("careerStart2"+careerStart2);
		careerEnd2 = Date.valueOf(multi.getParameter("careerEnd2"));
		
		
		System.out.println("careerEnd2"+careerEnd2);
		careerName2 = multi.getParameter("careerName2");
		System.out.println("careerName2"+careerName2);
		
		
		careerStart3 = Date.valueOf(multi.getParameter("careerStart3"));
		System.out.println("careerStart3"+careerStart3);
		careerEnd3 = Date.valueOf(multi.getParameter("careerEnd3"));
		careerName3 = multi.getParameter("careerName3");
		
		
		careerStart4 = Date.valueOf(multi.getParameter("careerStart4"));
		careerEnd4 = Date.valueOf(multi.getParameter("careerEnd4"));
		careerName4 = multi.getParameter("careerName4");
		
		careerStart5 = Date.valueOf(multi.getParameter("careerStart5"));
		System.out.println("careerStart5"+careerStart5);
		careerEnd5 = Date.valueOf(multi.getParameter("careerEnd5"));
		System.out.println("careerEnd5"+careerEnd5);
		careerName5 = multi.getParameter("careerName5");
		licenseName1 = multi.getParameter("licenseName1");
		System.out.println("licenseName1"+licenseName1);
		licenseName2 = multi.getParameter("licenseName2");
		System.out.println("licenseName2"+licenseName2);
		licenseName3 = multi.getParameter("licenseName3");
		licenseName4 = multi.getParameter("licenseName4");
		licenseName5 = multi.getParameter("licenseName5");

		System.out.println("licenseName1의값값값"+licenseName1);
