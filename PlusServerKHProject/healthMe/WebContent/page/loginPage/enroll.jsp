            ...
            <div id="contents">
                <div id="realContents">
                  <div class="info-container">
                    <form action="/enroll.do" id="userR" method="post">
                     
                        <label for="memberId">아이디 (4~12자 영문소문자, 숫자, 언더라인(_) 사용가능)</label><br>
                        <input type="text" id="memberId" name="memberId"><br>
                           <!-- /^[a-z0-9_]{4,12}$/ -->
    
                         <label for="memberPw">비밀번호 (8~24자 영문대소문자, 숫자, 특수문자 혼합 사용)</label><br>
                         <input type="password" id="memberPw" name="memberPw" ><br>
                           <!--  /^(?=.*[a-zA-Z])(?=.*[^a-zA-Z0-9]|.*[0-9]).{8,24}$/ -->

                         <label for="memberPw2">비밀번호 재확인</label><br>
                         <input type="password" name="memberPw2" id="memberPw2"><br>
                        
                        <label for="memberName">이름</label><br>
                        <input type="text" id="memberName" name="memberName"><br>
                         
                         <label for="memberSocailId">주민등록번호</label><br>
                        ...
                        <label for="memberPhone">핸드폰 번호</label><br>
                      ...
                      <button type="submit" value="회원가입" class="register-button">가입하기</button>
