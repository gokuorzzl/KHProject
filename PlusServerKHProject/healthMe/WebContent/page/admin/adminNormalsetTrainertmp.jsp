...
<%
	ArrayList<Trainer> list = (ArrayList<Trainer>)request.getAttribute("memberAllListTmp");
%>
							...
							<table class="table table-striped table-bordered table-hover">
								<!--       <table cellSpacing=0 borderColorDark=white width="760" bgColor=#c0c0c0 borderColorLight=#dddddd border=1 class="s1">-->
									...
									<tr bgColor=E0E4E8>
										...
										<td colSpan=4><font color="#333333">허락</font></td>
									...
									<td bgColor=#ffffff colSpan=4><a href="/adminTmpTrainerPPermit.do?memberId=<%=t.getMemberId()%>">허락</a></td>
