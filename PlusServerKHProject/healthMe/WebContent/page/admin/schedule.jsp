...
<link rel="stylesheet" href="/css/admin/calendar/bootstrap-theme.min.css">
<script type="text/javascript" src='/js/admin/sweetalert.min.js?ver=1'></script>
<link rel="stylesheet" type="text/css"
    href='/css/admin/calendar/sweetalert.css?ver=1.2'>
<script type="text/javascript" src="/js/admin/stringBuffer.js"></script>
<script type="text/javascript" src="/js/admin/calendar.js"></script>
<script type="text/javascript" src="/js/admin/calendarSchdule.js"></script>
<style type="text/css">
thead {
    text-align: center;
}
