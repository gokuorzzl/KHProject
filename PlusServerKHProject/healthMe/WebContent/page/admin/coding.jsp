...
<link rel="stylesheet" href="/css/admin/calendar/bootstrap.min.css">
<link rel="stylesheet" href="/css/admin/calendar/css/bootstrap-theme.min.css">
<script type="text/javascript" src='/js/admin/sweetalert.min.js?ver=1'></script>
<link rel="stylesheet" type="text/css" href='/css/admin/calendar/sweetalert.css?ver=1.2'>
<script type="text/javascript" src="/js/admin/calendarList.js"></script>
</head>
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- 캘린더 생성처리 form -->
                    <form action="./calendarAdd.do" method='post' id='frmCalendarAdd'><%--수정했다 --%>
